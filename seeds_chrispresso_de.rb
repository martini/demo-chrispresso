...
org1 = Organization.create_or_update(
  name: 'Chrispresso GmbH',
  note: 'Hersteller von individuellen Kaffeeprodukten.',
)
org2 = Organization.create_or_update(
  name: 'Awesome Customer AG',
  note: 'Globale Distributor von Kommunikations- und Security-Produkten sowie Draht & Kabel.',
)
org3 = Organization.create_or_update(
  name: 'Good Customer SE',
  note: 'Finden Sie die Informationen der Welt, einschließlich Web-Seiten, Bilder, Videos und vieles mehr. Gute Gründe für viel Besonderheiten.',
)
...
customer1 = User.create_or_update(
  ...
  note: 'mag Espresso Romano - Empfehlung für Espresso Con Panna',
  preferences: {
    'locale' => 'de-de',
  },
)
...
customer2 = User.create_or_update(
  ...
  roles: roles,
  organization_id: org2.id,
  note: 'mag Americano, hat zwei Einheiten bestellt',
  preferences: {
    'locale' => 'de-de',
  },
)
...
customer3 = User.create_or_update(
  ...
  roles: roles,
  organization_id: org2.id,
  note: 'Bestellte Café au Lait, nächstes mal nachfragen ob dieser Geschmack wie erwartet war.',
  preferences: {
    'locale' => 'de-de',
  },
)
...
customer4 = User.create_or_update(
  ...
  note: 'Kein Latte, dafür aber Macchiato',
  preferences: {
    'locale' => 'de-de',
  },
)
...
customer5 = User.create_or_update(
  ...
  active: true,
  roles: roles,
  note: 'Bestellte Viennese Melange, nächstes mal nachfragen ob dieser Geschmack wie erwartet war.',
  preferences: {
    'locale' => 'de-de',
  },
)
...
vielen Dank für die Empfehlung, ich möchte 2 weitere Einheiten von Viennese Melange.
...
<br/>
schön, wir liefern es an Deine Lieferadresse:<br/>
<br/>
#{customer1.address}.<br/>
<br/>
Du bekommst es am Dienstag.<br/>
...
article = Ticket::Article.create(
  ...
  to: 'order@chrispresso.com',
  body: "Liebes Chrispresso Team,<br/>
<br/>
<u>Bestellung:</u><br/>
...
<br/>
schön, wie liefern es an Deine Lieferadresse:<br/>
<br/>
#{customer2.address}.<br/>
<br/>
Du hast es am Montag.<br/>
Enjoy!<br/>
<span class='js-signatureMarker'></span>
<br/>
--<br/>
...
<br/>
fein, wir liefern es an Deine Lieferadresse:<br/>
<br/>
#{customer4.address}.<br/>
<br/>
Du wirst es am Mittwoch erhalten.<br/>
See you!<br/>
<span class='js-signatureMarker'></span>
<br/>
--<br/>
...
<br/>
schön, wir werden es an Deine Lieferadresse senden:<br/>
<br/>
#{customer5.address}.<br/>
<br/>
Du wirst es bis Mittwoche haben.<br/>
<span class='js-signatureMarker'></span>
<br/>
--<br/>
Grüße,<br/>
...
ticket5 = Ticket.create(
  #number: 10001,
  title: 'Beschwerde, falsche Lieferung der Bestellung #51519891',
  group: group1,
  customer: customer5,
  owner_id: 1,
  state: Ticket::State.find_by(name: 'closed'),
...
ticket6 = Ticket.create(
  #number: 10001,
  title: 'Beschwerde, falsche Inhalte in Bestellung #55194711',
  group: group1,
  customer: customer1,
  owner_id: 1,
  state: Ticket::State.find_by(name: 'closed'),
...
ticket7 = Ticket.create(
  #number: 10001,
  title: 'Vielen Dank! Großartiger Service!',
  group: group1,
  customer: customer3,
  owner_id: 1,
...
article = Ticket::Article.create(
  ...
  body: "Hallo Team,<br/>
<br/>
ich liebe ❤️ Euer Flat White!<br/>
<br/>
...
Calendar.init_setup('217.111.80.166')
